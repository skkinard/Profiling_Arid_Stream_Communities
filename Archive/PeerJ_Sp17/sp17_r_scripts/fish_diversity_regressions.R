...
myvariables <- which(colnames(msterfish) == "AP" |
                       colnames(msterfish) == "flash.index" |
                       colnames(msterfish) == "LFPP" |
                       colnames(msterfish) == "NH4."|
                       colnames(msterfish) == "log.cond"|
                       colnames(msterfish) == "canopy"|
                       colnames(msterfish) == "Rosgen.Index")
...
# Cleaned up tables in excel and stored in appendix "T2_F_lm"
