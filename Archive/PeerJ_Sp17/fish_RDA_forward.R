...
spe <- select(mster, A.melas:T.maculatus)
...
# 
#                  Df     AIC      F Pr(>F)  
# + NH4.            1 -5.6121 2.6213  0.028 *
#   + AP            1 -5.4732 2.4747  0.030 *
#   + LFPP          1 -5.0167 2.0073  0.078 .
# + log.cond        1 -4.8807 1.8721  0.090 .
# + canopy          1 -4.6141 1.6124  0.188  
# + Rosgen.Index    1 -3.8792 0.9313  0.448  
# + flash.index     1 -3.8493 0.9047  0.480  
#
# Step: spe.hel ~ NH4. 
# 
#                 Df     AIC      F Pr(>F)
# + log.cond      1 -5.6403 1.5740  0.118
# + AP            1 -5.4897 1.4458  0.206
# + Rosgen.Index  1 -5.0992 1.1223  0.374
# + flash.index   1 -4.9616 1.0114  0.430
# + LFPP          1 -4.5997 0.7266  0.648
# + canopy        1 -4.5002 0.6501  0.744
...
(spe.part.all <- varpart(spe.hel, env$AP, env$NH4., select(env, -AP, -NH4.)))
...
# step 1: The ordiplot object is obtained from the result of via function rda. The ordination is done with a community data set that is transformed by the Hellinger method as recommended in this article.
  ...
  Ordination.model2 <- rda(spe.hel ~ AP + NH4.,data=mster, scaling="species")
